...
- 项目地址: https://github.com/user1121114685/shadowsocksr
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/user1121114685/doubi/master/ssr.sh && chmod +x ssr.sh && bash ssr.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/user1121114685/doubi/master/ssrmu.sh && chmod +x ssrmu.sh && bash ssrmu.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/user1121114685/doubi/master/ssr_check.sh && chmod +x ssr_check.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/user1121114685/doubi/master/ssrstatus.sh && chmod +x ssrstatus.sh && bash ssrstatus
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/user1121114685/doubi/master/ssr_ip_check.sh && chmod +x ssr_ip_check.sh
```
